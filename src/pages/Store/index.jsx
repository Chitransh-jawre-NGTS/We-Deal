...
//           <div
//             key={product._id}
//             className={`bg-white flex flex-col relative group overflow-hidden shadow-md transition hover:shadow-xl hover:scale-105 ${isFeatured ? "border-2 border-yellow-400" : "border border-blue-300"
//               }`}
//           >
//             {/* Featured Badge */}
//             {isFeatured && (
...
//               {/* Price */}
//               <p
//                 className={`font-bold text-lg mt-3 ${isFeatured ? "text-yellow-600" : "text-blue-600"
//                   }`}
//               >
...
// import Navbar from "../../components/Navbar";
// import StoreCarousel from "../../components/StoreCrousal";
// import { getAllAds } from "../../api/storeApi/store"; // ✅ import API
...
//         if (data.ads) {
//           const featuredProducts = data.ads.filter((ad) => ad.price > 20000);
//           const normalMobiles = data.ads.filter((ad) => ad.price <= 20000);
        ...
        return (
          ...
          >
            ...
            <div className="p-4 flex flex-col flex-1">
              ...
              <p className="text-gray-500 text-sm mb-1">{store.location || "Location not specified"}</p>
            </div>
          </div>
        );
      })}
          ...
          <main className="flex-1">
            <section className="mb-10">
              ...
              {loading
                ...
                : renderProducts(getFilteredProducts([...featured, ...mobiles]))}
            </section>
          </main>
        </div>

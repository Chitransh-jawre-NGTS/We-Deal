    ...
    <div className="flex flex-col min-h-screen bg-white rounded-2xl">
      ...
      <main className="flex-grow p-4 md:p-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl md:text-4xl font-extrabold text-purple-700 mb-6 text-center flex items-center justify-center gap-2">
            <FaReceipt className="text-purple-600" /> Transaction History
          </h2>
            ...
            <>
                  ...
                  <tbody>
                    {transactions.map((txn, index) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4 font-bold text-purple-700">₹{txn.total}</td>
              ...
              <div className="md:hidden space-y-4">
                {transactions.map((txn) => (
                  <div
                    key={txn.id}
                    className="border border-purple-200 rounded-xl shadow-md p-4 bg-white"
                  >
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="font-bold text-purple-700">{txn.plan}</h3>
                      <span
                        className={`px-2 py-1 rounded-full text-white text-xs font-semibold ${
                          txn.plan === "Premium Plan"
                            ? "bg-purple-700"
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      ...
                      <p className="col-span-2 font-bold text-purple-700">
                        Total: ₹{txn.total}
                      </p>
              ...
              {/* Note Section */}
              <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-700 rounded-r-lg">

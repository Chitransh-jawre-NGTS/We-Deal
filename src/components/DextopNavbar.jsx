...
const DesktopNavbar = () => {
  ...
  const locRef = useRef(null); // ✅ ref for location dropdown
  ...
  // Fetch user profile once per route change
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        const res = await userApi.getProfile();
  ...
  const handleMouseLeave = () => {
    hideTimeoutRef.current = setTimeout(() => setOpen(false), 300);
  };
        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            ...
            >
              ...
              >
                <Link to="/profile" className="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition border-b">
                  <User size={18} /> <span>Profile</span>
                </Link>
                <Link to="/my-listings" className="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition border-b">
                  <Package size={18} /> <span>My Listings</span>
                </Link>
                <Link to="/become-seller" className="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition border-b">
                  <Package size={18} /> <span>Become Seller</span>
                </Link>
            ...
            <Link to="/login" className="text-gray-700 text-sm font-medium hover:text-blue-600 transition">
              Login
            </Link>
          )}
